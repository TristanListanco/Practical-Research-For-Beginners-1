  ...
  return (
    <SafeAreaView style={{ backgroundColor: colors.background, flex: 1 }}>
      ...
      >
        ...
        >
          <Image source={item.topicImage} style={{ resizeMode: "contain", width: "75%" }} />
        </View>
            ...
            >
              <View style={styles.bottomSheetContainer}>
                <View style={{ flexDirection: "column", marginTop: 10 }}>
                  <Text style={{ fontFamily: "SFProDisplay-Bold", fontSize: 35 }}>References</Text>
                  <FlatList data={researchTopics} renderItem={renderItem} keyExtractor={(item) => item.id} />
                </View>
              </View>
            </BottomSheetModal>
          </View>
